...
//system config
    ...
    //slider management
    Route::get('/slider','Admin\SliderController@getSlider')->middleware('not.login');
    Route::get('/create-slider','Admin\SliderController@getCreateNewSlider')->middleware('not.login');
    Route::post('/create-slider','Admin\SliderController@postCreateNewSlider')->middleware('not.login');
    ...
    //country
    Route::get('/{id}-country','Admin\CountryController@getCountry')->middleware('not.login');
    ...
    Route::get('/1/save-label','Admin\LabelsController@getLabelsAdmin')->middleware('not.login');
...
//User management
    ...
    Route::post('/user/edit-user-{id}','Admin\UserController@UpdateUser')->middleware('not.login');
